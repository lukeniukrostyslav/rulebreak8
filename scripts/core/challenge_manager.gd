...
func _append_extended_levels() -> void:
    var specs := [
        ["SEE", "see_shape_shift", "Find the shape that changed direction.", 1],
        ["SEE", "see_missing_edge", "Find the shape missing one edge.", 3],
        ["SEE", "see_rotation", "Find the rotated symbol.", 2],
        ["SEE", "see_size_change", "Find the only object with a different size.", 0],
        ["SEE", "see_pattern_break", "Find the object that breaks the pattern.", 2],
        ["SEE", "see_odd_symbol", "Find the only symbol from a different set.", 1],
        ["SEE", "see_position_shift", "Find the object in the wrong position.", 3],
        ["SEE", "see_filled_shape", "Find the only filled shape.", 0],
        ["SEE", "see_outline_break", "Find the only outlined object.", 2],
        ["SEE", "see_angle_change", "Find the object with a changed angle.", 1],
        ["SEE", "see_duplicate", "Find the duplicated shape.", 3],
        ["SEE", "see_color_change", "Find the object with a changed color.", 0],
        ["SEE", "see_spacing", "Find the object with different spacing.", 2],
        ["SEE", "see_direction", "Find the object pointing the wrong way.", 1],
        ["SEE", "see_symmetry", "Find the object that breaks symmetry.", 3],
        ["REMEMBER", "remember_colors", "Remember the three-color order.", 0],
        ["REMEMBER", "remember_shapes", "Remember the shape order.", 1],
        ["REMEMBER", "remember_numbers", "Remember three numbers in order.", 2],
        ["REMEMBER", "remember_corners", "Remember the occupied corners.", 0],
        ["REMEMBER", "remember_direction", "Remember the direction sequence.", 1],
        ["REMEMBER", "remember_pairs", "Remember the matching pair order.", 2],
        ["REMEMBER", "remember_lights", "Remember which lights appeared.", 3],
        ["REMEMBER", "remember_symbols", "Remember the symbol sequence.", 1],
        ["REMEMBER", "remember_path", "Remember the path.", 2],
        ["REMEMBER", "remember_slots", "Remember the filled slots.", 0],
        ["REMEMBER", "remember_tones", "Remember the tone order.", 3],
        ["REMEMBER", "remember_letters", "Remember the letters.", 2],
        ["REMEMBER", "remember_icons", "Remember the icons.", 1],
        ["REMEMBER", "remember_positions_2", "Remember four positions.", 0],
        ["REMEMBER", "remember_order_2", "Remember the original order.", 3],
        ["REACT", "react_red", "Tap when RED appears.", 0],
        ["REACT", "react_blue", "Tap when BLUE appears.", 1],
        ["REACT", "react_yellow", "Tap when YELLOW appears.", 3],
        ["REACT", "react_third", "React only to the third signal.", 2],
        ["REACT", "react_late", "Ignore the early signal and react late.", 1],
        ["REACT", "react_circle", "Tap only when the circle appears.", 0],
        ["REACT", "react_triangle", "Tap only when the triangle appears.", 2],
        ["REACT", "react_star", "Tap only when the star appears.", 3],
        ["REACT", "react_even", "React to the even signal.", 1],
        ["REACT", "react_fourth", "React only to the fourth signal.", 3],
        ["REACT", "react_after_change", "React only after the rule changes.", 1],
        ["REACT", "react_green_twice", "React to the second GREEN.", 1],
        ["REACT", "react_x_only", "Tap only on X.", 0],
        ["REACT", "react_signal_two", "Ignore signal one; react to signal two.", 1],
        ["REACT", "react_final", "React to the final signal.", 3],
        ["SWITCH", "switch_color", "The rule switches from BLUE to RED.", 1],
        ["SWITCH", "switch_direction", "The rule switches direction.", 1],
        ["SWITCH", "switch_after_two", "The rule changes after two actions.", 1],
        ["SWITCH", "switch_after_signal", "Switch when the signal appears.", 1],
        ["SWITCH", "switch_reverse", "The rule becomes reversed.", 1],
        ["SWITCH", "switch_number", "The target number changes.", 2],
        ["SWITCH", "switch_shape", "The target shape changes.", 3],
        ["SWITCH", "switch_instruction", "Follow the new instruction.", 1],
        ["SWITCH", "switch_timing", "The timing rule changes.", 1],
        ["SWITCH", "switch_action", "The required action changes.", 2],
        ["SWITCH", "switch_second_rule", "Use the second rule.", 1],
        ["SWITCH", "switch_after_three", "Change after three correct moves.", 1],
        ["SWITCH", "switch_direction_two", "The direction flips.", 3],
        ["SWITCH", "switch_target", "The target moves to another category.", 2],
        ...
        ["TRICK", "trick_forbidden", "The forbidden-looking option is correct.", 0],
        ["TRICK", "trick_slowest", "The slowest option is correct.", 2],
        ["TRICK", "trick_not_largest", "Do not choose the largest.", 0],
        ["TRICK", "trick_decoy", "Ignore the decoy.", 1],
        ["TRICK", "trick_mislead", "The instruction intentionally misleads.", 2],
        ["TRICK", "trick_exception", "Choose the exception.", 2],
        ["TRICK", "trick_wrong_label", "Ignore the label and follow the rule.", 1],
        ["TRICK", "trick_obvious_two", "The obvious second option is wrong.", 2],
        ["TRICK", "trick_contradiction", "Follow the latest rule.", 1],
        ["MIX", "mix_memory_switch", "Remember the pattern, then follow the changed rule.", 2],
        ["MIX", "mix_see_react", "Spot the visual change, then react.", 1],
        ["MIX", "mix_trick_react", "Ignore the decoy, then react to the signal.", 3],
        ["MIX", "mix_switch_memory", "Learn rule one, switch, then recall the target.", 0],
        ["MIX", "mix_full", "See, remember, switch and react in one round.", 2]
    ]
    for spec in specs:
